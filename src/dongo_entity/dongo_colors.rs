...
pub const DONGOCOLOR_GREEN: Srgba = Srgba::new(40, 100, 0, 255);
pub const DONGOCOLOR_DARKGREEN: Srgba = Srgba::new(0, 90, 0, 255);
...
pub const DONGOCOLOR_DARKGRAY: Srgba = Srgba::new(70, 70, 70, 255);